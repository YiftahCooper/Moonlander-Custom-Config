// DEPRECATED: Legacy Windhawk v1.2.8 rollback source.
// Preserved intentionally during the CopyQ migration. Do not overwrite or delete
// this file when merging; the active replacement is ../moonlander_language_sync.wh.cpp.
// ==WindhawkMod==
// @id              moonlander-language-sync-legacy-deprecated
// @name            Moonlander Language Sync (DEPRECATED Legacy Text Tools)
// @description     DEPRECATED rollback version: F18 language switching plus legacy F19/F22 clipboard text tools and RGB sync.
// @version         1.2.8
