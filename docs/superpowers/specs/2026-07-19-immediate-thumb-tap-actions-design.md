...
- The dedicated language timing override is inserted by the detected F18/Ctrl/F22 behavior signature, not a hard-coded dance index; patching fails if that dance cannot be identified.
