...
├── host_tools/windhawk/      ← Windows Windhawk mod (v1.2.4)
...
The Windhawk companion mod (`moonlander_language_sync.wh.cpp` v1.2.4) handles background Windows language state synchronization and manages three main keyboard shortcuts:
